          ...
          {isPending ? (
            ...
            <div className="dropdown dropdown-end">
              <label tabIndex={0} className="cursor-pointer">
                {/* User avatar circle */}
                <div className="w-9 h-9 rounded-full bg-clay-500 flex items-center justify-center text-white font-semibold text-sm ring-2 ring-clay-200 hover:ring-clay-400 transition-all">
                  {session.user?.image ? (
              ...
              <ul tabIndex={0} className="dropdown-content menu bg-white border border-clay-100 shadow-lg rounded-2xl p-2 w-48 mt-2 gap-1">
                <li>
                  <Link href="/my-profile" className="text-sm text-gray-700 hover:bg-clay-50 rounded-xl">
                    <FiUser size={14} /> My Profile
                  </Link>
                </li>
                <li>
                  <Link href="/all-tiles" className="text-sm text-gray-700 hover:bg-clay-50 rounded-xl">
                    <FiGrid size={14} /> All Tiles
                  </Link>
                </li>
                <div className="divider my-0.5 h-px bg-clay-100" />
                <li>
                  <button onClick={handleLogout} className="text-sm text-red-500 hover:bg-red-50 rounded-xl">
